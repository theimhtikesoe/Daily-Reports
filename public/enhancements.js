...
function processItemsForExcel(receipts) {
  ...
  receipts.forEach(receipt => {
    ...
    items.forEach(item => {
      ...
      const accessoryKeywords = ['accessories', 'merchandise', 'bong', 'paper', 'tip', 'grinder', 'shirt', 'hat', 'lighter', 'the lobby', 'merch', 'ashtray', 'ash tray', 'pipe', 'small pipe', 'best buds grinder', 'best buds shirt', 'balm 10g', 'pillow mist', 'balm', 'bileaf'];
